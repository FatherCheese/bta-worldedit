...
@Extension
public class LineCommand implements com.bta.util.CommandHandler
{
    @Override
            ...
            public boolean execute(CommandHandler commandHandler, CommandSender commandSender, String[] args)
            {
                if (args.length == 1)
                {
                    ...
                    for (List<Integer> coordinate : coordinates) {
                        int id = commandSender.getPlayer().worldObj.getBlockId(coordinate.get(0), coordinate.get(1), coordinate.get(2));
                        int meta = commandSender.getPlayer().worldObj.getBlockMetadata(coordinate.get(0), coordinate.get(1), coordinate.get(2));
                    ...
                    for (List<Integer> coordinate : coordinates) {
                        ...
                        commandSender.getPlayer().worldObj.setBlockAndMetadataWithNotify(coordinate.get(0), coordinate.get(1), coordinate.get(2), id1, meta1);
                    }
                    return true;
                }
